...
/**
 * Represents a database table definition for logging HTTP interface interactions.
 * This class defines the structure, constraints, and migrations for the log table.
 * @property HttpModule $module
 */
final class LogTable extends OrmTableBase
{
    public function __construct(HttpModule $module)
    {
        parent::__construct($module, DatabaseTables::HttpInterfaceLog, LogEntity::class);
    }
    ...
    protected function structure(Columns $cols, Constraints $constraints): void
    {
        ...
        $cols->enumObject("interface", HttpInterface::class)->options(...HttpInterface::getCases());
        ...
        $cols->int("alerts")->bytes(2)->unSigned()->nullable();
